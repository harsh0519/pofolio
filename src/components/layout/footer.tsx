          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 glass-effect rounded-full flex items-center justify-center text-(--text-secondary) hover:text-(--accent-primary) hover:border-(--accent-primary) transition-all"
              >
